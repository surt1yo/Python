# Students will build a real-time gesture control system that adjusts
# the system volume and screen brightness using hand gestures. By
# calculating the distance between the thumb and index finger, students
# will manipulate the volume and brightness on their computer in
# real-time.
