# Explore edge detection techniques 
# (Sobel, Canny, Laplacian) and apply
# noise reduction filters (Gaussian, Median) 
# interactively. Students will experiment 
# with parameters and observe their effects on real images.
import cv2
