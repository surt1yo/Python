"""
    This program listens to your spoken English, 
    converts it to text, translates it into a chosen language, 
    and then speaks out the translated text using text-to-speech.   
                                                                    """
import asyncio
import random
import pyttsx3
