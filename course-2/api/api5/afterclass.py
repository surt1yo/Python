# Students will build a sentiment analysis tool 
# that can classify text into positive, negative, 
# or neutral categories using the Hugging Face API. 
# They will learn to send API requests, 
# interpret the responses, and create a functional application.
